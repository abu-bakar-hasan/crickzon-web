...
export default function TrendingSection() {
  ...
  useEffect(() => {
    api.get("/products?limit=8")
      ...
      .catch((err) => console.error("TrendingSection error:", err))
  ...
  return (
    <section className="px-6 md:px-16 max-w-[1440px] mx-auto w-full">
      <div className="flex flex-col mb-8">
        <h2 className="text-2xl md:text-3xl font-bold text-[#0F172A] flex items-center gap-2">
          Trending Now <span className="text-[#F5A623]">🔥</span>
        </h2>
        <p className="text-gray-500 mt-1">What players are grabbing this week.</p>
      </div>
