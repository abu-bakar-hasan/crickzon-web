  ...
  if (!product) {
    return (
      <div className="flex flex-col items-center justify-center py-20 px-4 min-h-screen bg-white">
        ...
        <Link href="/store" className="text-[#0057A8] hover:underline">
          Return to Store
        </Link>
      </div>
    );
      ...
      >
        ...
        <div className="cz-pdp-info">
          ...
          <div style={{ fontSize: "13px", color: "#6B7280", marginBottom: "16px" }}>
            <Link href="/store" style={{ color: "#6B7280", textDecoration: "none" }}>
              Store
            </Link>
            {product.category && (
              <>
                ...
                <Link
                  href={`/store/c/${product.category.toLowerCase()}`}
          ...
          {/* Actions: Quantity & Add to Cart & Share */}
            ...
            >
              <button
                ...
                style={{
                  ...
                  border: "none",
                  fontSize: "18px",
                  cursor: !inStock || quantity <= 1 ? "not-allowed" : "pointer",
                  color: "#374151",
                }}
              >
                -
              ...
              <button
                ...
                style={{
                  ...
                  border: "none",
                  fontSize: "18px",
                  cursor: !inStock || quantity >= (selectedVariant?.stock || 0) ? "not-allowed" : "pointer",
                  color: "#374151",
                }}
              >
                +
